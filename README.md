...
### Step 1:
clone the githube repository onto theia IDE.
### Step 2:
create a new Django project
### Step 3:
write the needed HTML code.
### Step 4:
run the danjo sever and exicute the HTML files.
## Code:
```map.HTML
<!DOCTYPE html>
<html lang="en">
...
![output](./screenshots/out1 (1).jpg)

![output](./screenshots/out1 (2).jpg)

![output](./screenshots/out3.jpg)

![output](./screenshots/out4.jpg)

![output](./screenshots/out5.jpg)

![output](./screenshots/out6.jpg)

## HTML validator
![HTML validator](./screenshots/valid.jpg)

## Result:
the programe for implemnting image maps is executed successfully